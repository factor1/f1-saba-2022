...
},{"jquery":"../../node_modules/jquery/dist/jquery.js"}],"../../node_modules/micromodal/dist/micromodal.es.js":[function(require,module,exports) {
"use strict";
...
(0, _jquery.default)(document).ready(function () {
  ...
  (0, _jquery.default)(".menu-icon").on("click", function () {
    toggleMenu((0, _jquery.default)(this), (0, _jquery.default)(".nav--mobile"));
  }); // Close menu on desktop

  (0, _jquery.default)(window).on("resize", function () {
    if ((0, _jquery.default)(window).width() > 1024) {
      closeMenu((0, _jquery.default)(".menu-icon"), (0, _jquery.default)(".nav--mobile"));
    }
  }); // Close menu on outside click

  (0, _jquery.default)(document).on("click", function (e) {
    if (!(0, _jquery.default)(e.target).closest(".site-header").length) {
      closeMenu((0, _jquery.default)(".menu-icon"), (0, _jquery.default)(".nav--mobile"));
    }
  ...
  if ((0, _jquery.default)(".slider-section__slider").length) {
  ...
  _micromodal.default.init({
    onClose: function onClose() {
      (0, _jquery.default)("video").trigger("pause");
      stopVideo;
    }
  });

  var stopVideo = function stopVideo() {
    var videos = (0, _jquery.default)("iframe");
  ...
  (0, _jquery.default)(".card_slider__slider").slick({
    arrows: true,
    autoplay: false,
    dots: true,
    initialSlide: 0,
  ...
  var header = (0, _jquery.default)("#frontpage-menu");

  if (header) {
    (0, _jquery.default)(window).on("scroll", function () {
      var currentScroll = (0, _jquery.default)(this).scrollTop();

      if (currentScroll > 100) {
        header.slideDown("fast").addClass("fixed");
      } else {
        header.slideUp("fast").removeClass("fixed");
      }
    });
  } // Accordions 
  ...
  if ((0, _jquery.default)(".full-width-slider").length) {
    (0, _jquery.default)(".full-width-slider").slick({
      arrows: true,
      dots: true,
      autoplay: true,
      autoplaySpeed: 4000,
...
},{"bowser":"../../node_modules/bowser/es5.js","jquery":"../../node_modules/jquery/dist/jquery.js","slick-carousel":"../../node_modules/slick-carousel/slick/slick.js","micromodal":"../../node_modules/micromodal/dist/micromodal.es.js"}]},{},["theme.js"], null)
